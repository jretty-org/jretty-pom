...
:: add "-Pjretty-doc" to generate java docs -Pjretty-release
...
call mvn clean deploy -DaltDeploymentRepository=local.git.repo::file:///D:/__SYNC2/git/repository --settings %settings%
